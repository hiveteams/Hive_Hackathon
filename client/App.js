...
export default class App extends React.Component {
  ...
  handleLogin(username) {
    ...
    // TODO: Initialize Realtime helper using the init function
    // Hint: Your code should look something like this. You will need to update the loggedIn state in the onReady callback
    // Realtime.init(config, callback)
  }
